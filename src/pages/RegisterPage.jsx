...
const RegisterPage = () => {
  ...
  return (
    ...
    <div className="min-h-screen flex items-center justify-center p-4 py-8" style={{ backgroundImage: `url('${backgroundImage}')`, backgroundSize: 'cover', backgroundPosition: 'center', backgroundAttachment: 'scroll' }}>
      ...
      <div className="w-full max-w-[500px] mx-auto">
        ...
        <div className="bg-white rounded-xl shadow-xl p-8">
          ...
          <h2 className="text-2xl font-bold mb-1 ml-4" style={{ color: '#14532d' }}>
